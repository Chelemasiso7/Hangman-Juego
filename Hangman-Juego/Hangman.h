...
const std::string peliculasPalabras[numeroPalabras] = { "Endgame", "Antman", "George Lucas", "Scarlett Johansson", "Piratas", "Josh Brolin", "Power range rojo", "Monsters INC",
                                                        "Netflix", "Hulk" };

const std::string peliculasTips[numeroPalabras] = { "Pelicula mas taquillera de la historia", "Pelicula que su poder es hacerse bien pequeno", "Escritor de la saga de Star Wars",
...
const std::string culturaGeneralPalabras[numeroPalabras] = { "Juan Orlando","Maya", "Honduras", "Rusia", "Alaska", "Donald Trump", "Puerto Castilla", "Rio Amazonas", 
                                                             "Miguel de Cervantes", "Tierra"};

const std::string culturaGeneralTips[numeroPalabras] = { "Presidente de Honduras", "Cultura que usaba el cacao como moneda", "Pais de C.A con 5 estrellas en la bandera",
